...
(function() {
    ...
    exports.renderChatWindow = function(channelPath, callback) {
    ...
    exports.renderChatMessage = function(responseString, callback) {
    ...
    exports.renderChatActionEntry = function(responseString, callback) {
    ...
    exports.renderChatNickChange = function (commandResponse, callback) {
