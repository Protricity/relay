...
if(typeof module === 'object') (function() {
    var TEMPLATE_URL = 'keyspace/put/manage/render/ks-put-manage-form.html';
    ...
    module.exports.renderPutManageForm = function(url, status_box, callback) {
        ...
        function renderFileList(callback) {
            ...
            new_html_file_list += '\n\t<tr>';
            new_html_file_list += "\n\t\t<td><a onclick='Client.execute(\"PUT.MANAGE " + dirURL + "/\">.</a></td>";
            new_html_file_list += '\n\t</tr>';
            ...
            if(dirPath) {
                ...
                new_html_file_list += '\n\t<tr>';
                new_html_file_list += "\n\t\t<td><a onclick='Client.execute(\"PUT.MANAGE " + parentDirURL + "/\">..</a></td>";
                new_html_file_list += '\n\t</tr>';
            }
            ...
            KeySpaceDB.queryAll(file_search_pattern, function (err, contentEntry) {
                ...
                if (contentEntry) {
                    ...
                    if(unique.indexOf(requestURL) === -1) {
                        new_html_file_list += '\n\t<tr>';
                        new_html_file_list += "\n\t\t<td><a onclick='Client.execute(\"PUT.MANAGE " + requestURL + "\">" + contentEntry.path + "</a></td>";
                        new_html_file_list += '\n\t</tr>';
        ...
        function renderEntries(callback) {
            ...
            KeySpaceDB.queryAll(requestURL, function (err, contentEntry) {
                ...
                if (contentEntry) {
                    ...
                    new_html_entry_list += '\n\t<tr>';
                    new_html_entry_list += "\n\t\t<td><a onclick='Client.execute(\"PUT.MANAGE " + requestURL + "\">" + contentEntry.timestamp + "</a></td>";
                    new_html_entry_list += '\n\t</tr>';
