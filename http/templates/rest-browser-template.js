    ...
    var HTTP_BROWSER_TEMPLATE = "\
        <article class='channel http-browser:{$browser_id} http-browser http-response-{$response_code}' data-browser-id='{$browser_id}'>\n\
            ...
            <div class='title-commands'>\n\
                <a class='title-command-minimize' href='#MINIMIZE http-browser:{$browser_id}'>[-]</a><!--\
             --><a class='title-command-maximize' href='#MAXIMIZE http-browser:{$browser_id}'>[+]</a><!--\
             --><a class='title-command-close' href='#CLOSE http-browser:{$browser_id}'>[x]</a>\n\
            </div>\n\
            <nav>\n\
